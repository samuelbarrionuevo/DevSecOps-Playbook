...
| 1.5 | Commit Signing | 2 | Sign all commits to verify that the author is genuine | <span style="color: green">Easy</span> | <ul><li>APRA234</li><li>CIS8</li><li>NIST 800-53B</li><li>SSDF1.1</li></ul> |
